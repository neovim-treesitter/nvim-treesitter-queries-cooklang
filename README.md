# nvim-treesitter-queries-cooklang

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cooklang/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cooklang/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cooklang**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cooklang",
...
- [ ] Changes are scoped to `cooklang` — do not include files for other languages
